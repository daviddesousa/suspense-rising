        ...
        {activeExperience === 'choose' ? (
          ...
          >
            <div className="flex justify-between items-end">
              <div>
                <h3 className="text-xs uppercase tracking-[0.2em] text-neutral-500 mb-1">Select your number</h3>
                <p className="text-sm font-light text-neutral-400">Figures are limited and unique.</p>
              </div>
              <div className="text-right">
                <span className="text-xl font-black tabular-nums">{availableCount}</span>
            ...
            <div className="pt-4">
              <button
                ...
                className={`
                  w-full py-4 bg-white text-black text-xl font-black uppercase tracking-widest transition-all
                ...
                `}
              >
                {isLoading ? 'Processing...' : selectedVariantId ? `Buy Figure #${variants.findIndex(v => v.id === selectedVariantId) + 1}` : 'Select a Number'}
              </button>
            </div>
          </Motion.div>
        ) : (
          ...
          >
            <div className="text-center space-y-4 max-w-sm mx-auto">
              ...
              <h2 className="text-2xl font-bold uppercase tracking-tighter">Let Haslow Choose</h2>
              <p className="text-neutral-400 leading-relaxed">
                You buy a number blindly and you won't know which one you got until you receive your package.
              </p>
            </div>
            ...
            <div className="pt-4">
              <button
                ...
                className={`
                  w-full py-4 bg-amber-600 text-black text-xl font-black uppercase tracking-widest transition-all
                ...
                `}
              >
                {availableCount === 0 ? 'Sold Out' : isLoading ? 'Processing...' : 'Let Haslow Choose'}
              </button>
            </div>
          </Motion.div>
        )}
